...
functiondata = [
    {
        ...
        "description": f"""My db name -${DatabaseName} ${productlines}: If user asking about any Columns which is present into that then trigger it""",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
    ...
    {
        "name": "getAnyInformation",
        "description": f"""My db -${DatabaseName} ${customers}:   If user asking about any Columns which is present into that then trigger it""",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
    ...
    {
        "name": "getAnyInformation",
        "description": f"""My db -${DatabaseName} ${products}:   If user asking about any Columns which is present into that then trigger it""",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
    ...
    {
        "name": "getAnyInformation",
        "description": f"""My db -${DatabaseName} ${products} and ${orderdetails}:   If user asking about any Columns which is present into that then trigger it""",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
    ...
    {
        "name": "getAnyInformation",
        "description": f"""My db -${DatabaseName} ${employees}:   If user asking about any Columns which is present into that then trigger it""",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
    ...
    {
        "name": "getAnyInformation",
        "description": f"""My db -${DatabaseName} ${orders}:   If user asking about any Columns which is present into that then trigger it""",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
    ...
    {
        "name": "getAnyInformation",
        "description": f"""My db -${DatabaseName} ${offices}:   If user asking about any Columns which is present into that then trigger it""",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
    ...
    {
        "name": "getAnyInformation",
        "description": f"""My db -${DatabaseName} ${Payments} and ${customers}:   If user asking about any Columns which is present into that then trigger it""",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
